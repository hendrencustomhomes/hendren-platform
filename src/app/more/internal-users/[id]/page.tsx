          ...
          <>
            <div style={sectionCardStyle}>
              ...
              <div style={{ padding: 10, display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 62px 78px', gap: 6 }}>
                  <div>
            ...
            {canManage && (
              <div style={sectionCardStyle}>
                ...
                <div style={{ padding: 10, display: 'flex', gap: 5, flexWrap: 'wrap' }}>
          ...
          <>
            <div style={sectionCardStyle}>
              <div style={sectionHeaderStyle}>
                ...
                <Link href="/more/internal-users/templates" style={{ fontSize: '10px', color: 'var(--text)', whiteSpace: 'nowrap' }}>
                  Templates
                </Link>
              </div>
              ...
              <div style={{ padding: 10, display: 'flex', flexDirection: 'column', gap: 6 }}>
                {error && <div style={{ color: '#fca5a5', fontSize: '11px' }}>{error}</div>}
                {accessSuccess && <div style={{ color: '#86efac', fontSize: '11px' }}>{accessSuccess}</div>}
                    ...
                    {workflowRoles.map((workflow) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {isLocked && <span style={{ fontSize: '9px', color: 'var(--text-muted)' }}>default</span>}
                        </label>
                      )
                    })}
                  </div>
