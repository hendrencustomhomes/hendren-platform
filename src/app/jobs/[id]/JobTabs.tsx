      ...
      >
        {TABS.map((t) => (
          <button
            key={t}
            onClick={() => {
              if (tab === 'info' && t !== 'info' && isEditingInfo) {
                cancelInfoEdit()
              }
              setTab(t)
            }}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          >
            ...
            <div style={{ fontSize: '12px', marginBottom: '6px' }}>
              <strong>PM:</strong> {(job.profiles as any)?.full_name || '—'}
            </div>
          ...
          >
            ...
            <div style={{ fontSize: '12px' }}>
              ...
              {!isEditingInfo ? (
                ...
                <input
                  value={infoDraft.drive_folder_url}
                  onChange={(e) => setInfoDraft((d) => ({ ...d, drive_folder_url: e.target.value }))}
                  style={inp}
                />
              )}
            </div>
      ...
      {tab === 'subs' && (
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '10px' }}>
          ...
          >
            ...
            <a
              href={`/schedule/sub/new?job=${jobId}`}
              style={{
                fontSize: '11px',
                fontWeight: '600',
                padding: '4px 10px',
      ...
      {tab === 'orders' && (
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '10px' }}>
          ...
          >
            ...
            <a
              href={`/schedule/order/new?job=${jobId}`}
              style={{
                fontSize: '11px',
                fontWeight: '600',
                padding: '4px 10px',
