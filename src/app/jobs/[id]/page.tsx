...
export default async function JobDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const STATUS_COLORS: Record<string,string> = {tentative:'#b45309',confirmed:'#16a34a',on_site:'#2563eb',complete:'#888',cancelled:'#dc2626',Pending:'#b45309',Ordered:'#2563eb',Confirmed:'#16a34a',Delivered:'#888',Issue:'#dc2626',not_started:'#888',in_progress:'#b45309',selected:'#2563eb',locked:'#16a34a',on_hold:'#dc2626'}
      ...
      <div style={{padding:'14px',maxWidth:'960px',margin:'0 auto'}}>
        ...
        <div style={{background:'var(--surface)',border:'1px solid var(--border)',borderRadius:'10px',padding:'12px 14px',marginBottom:'12px',overflowX:'auto'}}>
          <div style={{display:'flex',gap:'2px',minWidth:'fit-content'}}>
            {STAGES.map((stage,i) => {
              const done=i<curIdx, active=i===curIdx, pct=stagePct(stage)
              return (
